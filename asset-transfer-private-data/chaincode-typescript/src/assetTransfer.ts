...
export class AssetTransfer extends Contract {
    ...
    public async InitLedger(ctx: Context): Promise<void> {
        const assets: Asset[] = sampleData.sampleData
        console.log("InitLedger", assets.length)
    ...
    public async CreateAsset(ctx: Context): Promise<void> {
        ...
        const asset: Asset = {
            ...
            createdMethod: jsonFromString.createdMethod,
            propertyStatus: jsonFromString.propertyStatus,
            propertyReferenceNumber: jsonFromString.propertyReferenceNumber,
            propertyHeldInfos: jsonFromString.propertyHeldInfos,
            propertyAddress: jsonFromString.propertyAddress,
            propertyChineseAddress: jsonFromString.propertyChineseAddress,
            propertyShareOfTheLocation: jsonFromString.propertyShareOfTheLocation,
            propertyRemarks: jsonFromString.propertyRemarks,
            transactionHistory: jsonFromString.transactionHistory,
            deedsPendingRegistration: jsonFromString.deedsPendingRegistration,
            deedsPendingRegistrationRejected: jsonFromString.deedsPendingRegistrationRejected,
            incumbranceHistory: jsonFromString.incumbranceHistory,
            incumbrancePendingRegistration: jsonFromString.incumbrancePendingRegistration,
            incumbrancePendingRegistrationRejected: jsonFromString.incumbrancePendingRegistrationRejected,
            version: 0,
            createdAt: new Date(),
            updatedAt: new Date()
        ...
        // ObjectType: jsonFromString.objectType,
    ...
    public async DeleteTransferAgreement(ctx: Context): Promise<void> {
        console.log("DeleteTransferAgreement")
        // Value is private, therefore it gets passed in transient field
        const transientMap = ctx.stub.getTransient();
        // Persist the JSON bytes as-is so that there is no risk of nondeterministic marshaling.
    ...
    */
    ...
    public async ReadAsset(ctx: Context, id: string): Promise<Asset> {
        ...
        const asset: Asset = {
            ID: jsonFromBytes.ID,
            version: jsonFromBytes.version,
            createdAt: jsonFromBytes.createdAt,
            updatedAt: jsonFromBytes.updatedAt,
            createdMethod: jsonFromBytes.createdMethod,
            propertyStatus: jsonFromBytes.propertyStatus,
            propertyReferenceNumber: jsonFromBytes.propertyReferenceNumber,
            propertyHeldInfos: jsonFromBytes.propertyHeldInfos,
            propertyAddress: jsonFromBytes.propertyAddress,
            propertyChineseAddress: jsonFromBytes.propertyChineseAddress,
            propertyShareOfTheLocation: jsonFromBytes.propertyShareOfTheLocation,
            propertyRemarks: jsonFromBytes.propertyRemarks,
            transactionHistory: jsonFromBytes.transactionHistory,
            deedsPendingRegistration: jsonFromBytes.deedsPendingRegistration,
            deedsPendingRegistrationRejected: jsonFromBytes.deedsPendingRegistrationRejected,
            incumbranceHistory: jsonFromBytes.incumbranceHistory,
            incumbrancePendingRegistration: jsonFromBytes.incumbrancePendingRegistration,
            incumbrancePendingRegistrationRejected: jsonFromBytes.incumbrancePendingRegistrationRejected

        };
        console.log("ReadAsset", asset)
        return asset;
    }
    ...
    public async ReadAssetPrivateDetails(ctx: Context, collection: string, id: string): Promise<AssetPrivateDetails> {
        console.log("ReadAssetPrivateDetails", collection, id)
        // Check if asset already exists
    ...
    public async ReadTransferAgreement(ctx: Context, assetID: string): Promise<TransferAgreement> {
        console.log("ReadTransferAgreement", assetID)
    ...
    public async GetAssetByRange(ctx: Context, startKey: string, endKey: string): Promise<Asset[]> {
        console.log("GetAssetByRange", startKey, endKey)
        ...
        for await (const res of resultsIterator) {
            ...
            results.push({
                ...
                version: jsonFromString.version,
                createdAt: jsonFromString.createdAt,
                updatedAt: jsonFromString.updatedAt,
                createdMethod: jsonFromString.createdMethod,
                propertyStatus: jsonFromString.propertyStatus,
                propertyReferenceNumber: jsonFromString.propertyReferenceNumber,
                propertyHeldInfos: jsonFromString.propertyHeldInfos,
    ...
    */
    ...
    public async getCollectionName(ctx: Context): Promise<string> {
        ...
        console.log("getCollectionName", clientMSPID, orgCollection)
    ...
    public async submittingClientIdentity(ctx: Context): (Promise<string>) {
        ...
        console.log("submittingClientIdentity", b64ID, decodeID)
    ...
    public async verifyClientOrgMatchesPeerOrg(ctx: Context): (Promise<void>) {
        ...
        console.log("verifyClientOrgMatchesPeerOrg", clientMSPID, peerMSPID)
        return null;
