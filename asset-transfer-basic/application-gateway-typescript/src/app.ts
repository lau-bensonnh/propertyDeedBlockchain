...
async function main(): Promise<void> {
    ...
    try {
        ...
        console.log('get network success')
        ...
        await createAsset(contract, JSON.stringify(asset));

        console.log('createAsset success')
        // Update an existing asset asynchronously.
        await transferAssetAsync(contract);

        console.log('transferAssetAsync success')
        // Get the asset details by assetID.
        await readAssetByID(contract);

        console.log('readAssetByID success')
        // Update an asset which does not exist.
        await updateNonExistentAsset(contract)
        console.log('updateNonExistentAsset success')
    } finally {
        gateway.close();
        client.close();
    }
 ...
 */
async function createAsset(contract: Contract, assetJson: string): Promise<void> {
    console.log('\n--> Submit Transaction: CreateAsset, creates new asset with ID, assetJson arguments');
